...
<div class="bg-secondary">
  ...
  <div class="common-box">
    ...
    <div class=" common-box w-[95%] bg-white rounded-[15px] m-auto relative ">
      ...
      <section class="inner_whyus why-us  common-box pt-0 relative ">
        <div class="container common-box pb-0 scroll-wrap">
        ...
        <section class="common-box  package-list relative top-70 -mt-65">
          <div class="container ">
            <h2 class="package__section-title">
